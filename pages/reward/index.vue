            ...
            <v-row>
                        ...
                        <v-card-text>
                            <div class="d-flex">
                                ...
                                <div class="align-self-center">
                                    <h2 class="text-main name text-primary">{{ getLine.displayName }}</h2>
                                </div>
                            </div>
                        </v-card-text>
                ...
                <v-col cols="12" class="text-center">
                    <div class="set-padding">
                        <v-btn rounded color="primary" dark class="w-100 mt-6 my-btn" @click="scan">
                        ...
                        <div v-if="1>2" class="w-100 my-btn-disabled text-disabled outlined mt-5">Redeem Reward</div>
                        <div v-else class="w-100 my-btn text-primary outlined mt-5" @click="redeem">Redeem Reward</div>
                    </div>
                </v-col>
            </v-row>
        </v-container>
